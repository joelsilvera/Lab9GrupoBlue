...
<jsp:include page="/static/head.jsp">
    <jsp:param name="title" value="Edit Efectividades"/>
</jsp:include>
<body>
<div class='container'>
    <!--Colocar como value: artistas, canciones, bandas, tours o tpc  (dependiendo de la pagina a la que corresponda) -->
    <jsp:include page="/includes/navbar.jsp">
        <jsp:param name="page" value="Efectividades"/>
    </jsp:include>
    <div class="pb-5 pt-4 px-3 titlecolor d-flex justify-content-between align-items-center">
        <div class="col-lg-6">
            <h1 class='text-light'>Editar Efectividades</h1>
        </div>
    </div>
    <div class="tabla">
        <div class='container'>
                ...
                <div class="col-md-6">
                    <table class="table table-dark table-transparent table-hover">
                        ...
                        <tr>
                            ...
                            <form method="POST" action="<%=request.getContextPath()%>/ObjetosServlet?a=editEfectividad&idVacuna=<%=idVacuna%>&idZombie=<%=i%>">
