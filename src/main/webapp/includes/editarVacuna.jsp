...
<jsp:include page="/static/head.jsp">
    <jsp:param name="title" value="Editar Vacuna"/>
</jsp:include>
<body>
<div class='container'>
    ...
    <div class="pb-5 pt-4 px-3 titlecolor d-flex justify-content-between align-items-center">
        <div class="col-lg-6">
            <h1 class='text-light'>Editar Vacuna</h1>
        </div>
    </div>
    <div class="tabla">
        <div class='container'>
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    <form method="POST" action="<%=request.getContextPath()%>/ObjetosServlet?a=actualizarObjeto&esVacuna=Si&idObjeto=<%=idObjeto%>">
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-success">Editar Efectividades</button>
                    </form>
                </div>
                <div class="col-md-3"></div>
            </div>
