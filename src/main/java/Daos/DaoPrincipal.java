...
public class DaoPrincipal {
    ...
    public ArrayList<BeanSuperviviente> listarSuperviviente() {
        ...
        try (Connection connection = DriverManager.getConnection(url, user, pass);
            ...
            while (rs.next()) {
                ...
                superviviente.setIdInt(rs.getInt(1));
    ...
    public ArrayList<BeanSuperviviente> buscarPorSexo(String textoBuscar) {
        ArrayList<BeanSuperviviente> listaSuperviviente = new ArrayList<>();
    ...
    public void borrar(String humanId, int supId) {
        ...
        String sql2 = "delete from supervivientes where humanos_idhumanos = ?";
        ...
        String sql3 = "delete from superviviente_has_objetos where supervivientes_idsupervivientes = ?";
